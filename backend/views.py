    ...
    def post(self, request, *args, **kwargs):
        ...
        if {'email', 'token'}.issubset(request.data):
            ...
            if token:
                ...
                return JsonResponse({'Status': False, 'Errors': 'Token or email address is incorrect'})
...
class LoginAccount(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if {'email', 'password'}.issubset(request.data):
            ...
            return JsonResponse({'Status': False, 'Errors': 'No authorized'})
...
class PartnerUpdate(APIView):
    ...
    def post(self, request: Request, *args, **kwargs):
        ...
        if request.user.type != 'shop':
            return JsonResponse({'Status': False, 'Error': 'Эта функция только для магазинов'}, status=403)
        ...
        if {'id', 'contact'}.issubset(request.data):
            if request.data['id'].isdigit():
                try:
                    ...
                    print(error)
                    return JsonResponse({'Status': False, 'Errors': 'arguments are specified incorrectly'})
                else:
                    if is_updated:
